...
--
-- Host: 127.0.0.1
-- Tempo de geração: 29-Set-2021 às 15:37
...
(51, 'luiz fernando pinage', '(92) 99999-999', 'luiz.c@progride.com.br', '004.963.342-20', '69093', '2021-09-24', '{\"tpservico\":\"Lavanderia\",\"categoria\":[\"Bolsas\",\"Sapatos\"],\"descricao\":false,\"quantidade\":[]}', 'AM', 'Manaus', 'Rua Pio IX', 'Monte das Oliveiras', 'proximo ao manoa', '2250 070002240921', '034', 'F'),
(52, 'fernando pinage', '(92) 88888-999', 'luizfernandoluck@progride.com.br', '004.963.342-20', '69093', '2021-09-24', '{\"tpservico\":\"Lavanderia\",\"categoria\":[\"Bolsas\",\"Sapatos\"],\"descricao\":false,\"quantidade\":[]}', 'AM', 'Manaus', 'Rua Pio IX', 'Monte das Oliveiras', 'proximo ao manoa', '3789 070743240921', '034', 'C'),
...
(58, 'luiz fernando pinage', '(92) 99999-999', 'luiz.c@progride.com.br', '004.963.342-20', '69006262', '2021-09-29', '{\"tpservico\":\"Motoboy\",\"categoria\":[\"Enviar um documento\",\"Serviço de urgência\",\"\"]}', 'AM', 'Manaus', 'Rua Pio IX', 'Monte das Oliveiras', 'proximo ao manoa', '1981 015050290921', '034', 'A'),
(59, 'luiz fernando pinage', '(92) 99999-999', 'luiz.c@progride.com.br', '004.963.342-20', '69006262', '2021-09-29', '{\"tpservico\":\"Motoboy\",\"categoria\":[\"Enviar um documento\",\"Serviço de urgência\",\"\"]}', 'AM', 'Manaus', 'Rua Pio IX', 'Monte das Oliveiras', 'proximo ao manoa', '9285 015339290921', '034', 'A'),
(60, 'luiz fernando pinage', '(92) 99999-999', 'luiz.c@progride.com.br', '004.963.342-20', '69006262', '2021-09-29', '{\"tpservico\":\"Diarista\",\"categoria\":[\"Limpeza pré mudança\",\"\"],\"descricao\":[\"Qual a área do imóvel? 170,62m²\"],\"local\":[\"Qual o local do serviço? Comercial\"],\"dependente\":[\"Crianças<\"],\"serviço\":[\"Precisa de serviços adicionais? Passar roupa\",\"\"],\"termo\":\"mensal\"}', 'AM', 'Manaus', 'Rua Pio IX', 'Monte das Oliveiras', 'proximo ao manoa', '8502 020025290921', '034', 'A'),
(61, 'luiz fernando pinage', '(92) 99999-999', 'luiz.c@progride.com.br', '004.963.342-20', '69006262', '2021-09-29', '{\"tpservico\":\"Diarista\",\"categoria\":[\"Limpeza pré mudança\",\"\"],\"descricao\":[\"Qual a área do imóvel? 170,62m²\"],\"local\":[\"Qual o local do serviço? Comercial\"],\"dependente\":[\"Crianças<\"],\"serviço\":[\"Precisa de serviços adicionais? Passar roupa\",\"\"],\"termo\":\"mensal\"}', 'AM', 'Manaus', 'Rua Pio IX', 'Monte das Oliveiras', 'proximo ao manoa', '9973 020044290921', '034', 'A'),
(62, 'luiz fernando pinage', '(92) 99999-999', 'luiz.c@progride.com.br', '004.963.342-20', '69006262', '2021-09-29', '{\"tpservico\":\"Diarista\",\"categoria\":[\"Limpeza pré mudança\",\"\"],\"descricao\":[\"Qual a área do imóvel? 170,62m²\"],\"local\":[\"Qual o local do serviço? Comercial\"],\"dependente\":[\"Crianças<\"],\"serviço\":[\"Precisa de serviços adicionais? Passar roupa\",\"\"],\"termo\":\"mensal\"}', 'AM', 'Manaus', 'Rua Pio IX', 'Monte das Oliveiras', 'proximo ao manoa', '8290 020048290921', '034', 'A');
...
(14, 'rhuan mendin', 'J', 'medin', 'luiz.c@progride.com.br', '004.963.342-20', '(92) 99999-9999', '69006262', 'AM', 'Rua 11 de Agosto', '034', 'Manaus', 'Gilberto Mestrinho', 'complemento', 'pp.jpg', '63a9f0ea7bb98050796b649e85481845', 'Lavanderia'),
(15, 'Orismar ', 'J', 'Orismar', 'luizfernandoluck@hotmail.com', '123456789', '(92) 99999-9999', '69006262', 'AM', 'Rua 11 de Agosto', '034', 'Manaus', 'Gilberto Mestrinho', 'complemento', 'pp.jpg', '63a9f0ea7bb98050796b649e85481845', 'Lavanderia');
...
CREATE TABLE `servico` (
  ...
  `servico_status` varchar(1) NOT NULL,
  `servico_protocolo` varchar(100) NOT NULL,
  `servico_profissional` varchar(300) NOT NULL,
  `servico_data` date NOT NULL,
  `servico_idprofissional` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `servico` (`servico_id`, `servico_status`, `servico_protocolo`, `servico_profissional`, `servico_data`, `servico_idprofissional`) VALUES
(23, 'F', '2250 070002240921', 'rhuan mendin - (92) 99999-9999 - luiz.c@progride.com.br', '2021-09-29', 14);
...
ALTER TABLE `servico`
  ...
  ADD UNIQUE KEY `servico_protocolo` (`servico_protocolo`);
...
--
ALTER TABLE `pedido`
  MODIFY `pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
...
--
ALTER TABLE `servico`
  MODIFY `servico_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
