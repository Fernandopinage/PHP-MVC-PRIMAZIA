       ...
       try {
        ...
        //Server settings
            ...
            $mail->Body    = '
                                ...
                                <a href="localhost/primazia_projeto/view/cliente/novasenha.php?key='.base64_encode($id).'&mail='.base64_encode($email).'&pass='.$senha.'">Click aqui</a><br><br><br>
