...
<div id="desktop">
    <div id="conteudo-left">
        ...
        <div class="container">
            ...
            <form action="diarista.php" method="post">
                ...
                <div id="form-row">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" name="outros" id="outros" title="Limpeza geral pós instalação de móveis e decoração, deixando o ambiente limpo a mudança do cliente.">
