            ...
            <div id="form-row">
                ...
                <div class="row g-3 mt-1">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-check-input" name="termo" <?php echo $dados['termo'] == "on" ? 'checked' : '' ?> type="checkbox" id="flexCheckDefault" checked disabled>
                    </div>
                    <!-- Modal -->
...
<script>
    ...
    function change() {
        ...
        if (value === 'Artífice (Eletricistas, Pintor e Hidráulico)') {
            $('#pergunta06').show();
        } else {
            $('#pergunta06').hide();
        }
